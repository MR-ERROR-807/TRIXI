...
AUTHOR:
<p align="center">
MR.ERROR TRIXI TOOL <img src="https://emojis.slackmojis.com/emojis/images/1588315024/8823/hyperkitty.gif" width="35px"></i></b></h2> 
...
cd $HOME
rm -rf TRIXI
git clone https://github.com/MR-ERROR-807/TRIXI
cd TRIXI
python TRIXI.py
```
